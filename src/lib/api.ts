...
export const api = {
  ...
  updateWaterBodyPassport: async (
    id: string,
    body: { passport: WaterBodyPassport },
  ): Promise<WaterBody> => {
    return request<WaterBody>(`/water-bodies/${id}`, {
      method: 'PUT',
      body: JSON.stringify(body),
  ...
  getProblems: async (): Promise<WaterBodyProblem[]> => {
    return request<WaterBodyProblem[]>('/problems', {
      method: 'GET',
    });
  },
  ...
  ): Promise<WaterBodyProblem> => {
    return request<WaterBodyProblem>(`/problems/${id}`, {
      method: 'PATCH',
      body: JSON.stringify(body),
    });
  },

  deleteProblem: async (id: string): Promise<{ id?: string; message?: string }> => {
    return request<{ id?: string; message?: string }>(`/problems/${id}`, {
      method: 'DELETE',
    });
  },
